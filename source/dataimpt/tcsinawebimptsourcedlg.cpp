...
tcSinaWebImportSourceDialog::tcSinaWebImportSourceDialog(QWidget *pParent)
	: QDialog(pParent)
{
	setupUi(this);
...
tcSinaWebImportSourceDialog::~tcSinaWebImportSourceDialog()
{
}

bool tcSinaWebImportSourceDialog::SetSettings(const QStringList &pUrlList)
{
...
bool tcSinaWebImportSourceDialog::GetSettings(QStringList &pUrlList)
{
	pUrlList.clear();
	int i;
...
void tcSinaWebImportSourceDialog::UrlListChanged(QTableWidgetItem *pItem)
{
	int i;
...
#include "moc_tcsinawebimptsourcedlg.cpp"
